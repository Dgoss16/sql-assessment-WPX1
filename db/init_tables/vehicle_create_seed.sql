...
CREATE TABLE IF NOT EXISTS vehicles (
  ...
  make VARCHAR(50), --(add datatype and/or table contraint),
  model VARCHAR(50), --(add datatype and/or table contraint),
  year INT, --(add datatype and/or table contraint),
  owner_id INT REFERENCES users(id) --(add datatype and/or table contraint)
);
